...
// TON transfers between L1 and L2 using the Optimism SDK
...
const reportERC20Balances = async () => {
  ...
  console.log(`TON on L1:${l1Balance}     TON on L2:${l2Balance}`)

  if (l1Balance != 0) {
    console.log(`You have TON on L1.`)
    return
  }

  console.log(`You don't have enough TON on L1. Let's call the faucet to fix that`)
}    // reportERC20Balances
