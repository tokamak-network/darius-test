...
const L2StandardTokenFactoryArtifact = require(`../artifacts/contracts/L2/messaging/L2StandardTokenFactory.sol/L2StandardTokenFactory.json`);
  ...
  console.log(`
{
    ...
    "decimals": ${decimals},
    "tokens": {
      "L1 Token address": "${process.env.L1_TOKEN_ADDRESS}",
